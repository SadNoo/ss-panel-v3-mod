...
//
// !!! 修改此key为随机字符串确保网站安全 !!!
$System_Config['key'] = 'lhie1x';
$System_Config['debug'] =  'false';  //  正式环境请确保为false
$System_Config['appName'] = '墙洞';             //站点名称
$System_Config['baseUrl'] = 'https://xn--nos809b.com';            // 站点地址
$System_Config['timeZone'] = 'PRC';        // PRC 天朝时间  UTC 格林时间
$System_Config['pwdMethod'] = 'sha256';       // 密码加密   可选 md5,sha256
$System_Config['salt'] = 'a531678388';               // 密码加密用，从旧版升级请留空
...
$System_Config['db_password'] = 'huwen';
...
$System_Config['smtp_username'] = 'admin@lhie1.com';
$System_Config['smtp_port'] = '465';
$System_Config['smtp_name'] = 'admin@lhie1.com';
$System_Config['smtp_sender'] = '墙洞';
$System_Config['smtp_passsword'] = '4pvCcbxGqqr9rdEh ';
...
#端口池
$System_Config['min_port']='30000';
$System_Config['max_port']='36000';
...
$System_Config['reg_auto_reset_bandwidth']='120';

#Cloudxns
$System_Config['cloudxns_apikey']='4ffcb25a3e40358ae204ddbd41d2dab6';#自己去 cloudxns.net 申请
$System_Config['cloudxns_apisecret']='316232aa9ee8c7f4';
$System_Config['cloudxns_domain']='xn--nos809b.com';#你的域名



#自动备份设置
$System_Config['enable_auto_backup']='false';
$System_Config['auto_backup_email']='lhie1x@gmail.com';
$System_Config['auto_backup_webroot']='/www/wwwroot/xn--nos809b.com';
$System_Config['auto_backup_passwd']='lhie1';
...
$System_Config['geetest_id']='3bc1dd3948ca3dc97862e309d25b8d21';
$System_Config['geetest_key']='d14b61bc5e8963388a1dd48aea5a88a0';
...
$System_Config['telegram_token']='568345194:AAG31YExREwE3xN7sSqEjh6huSzOmKes6l8';

#telegram bot,群组会话 ID,把机器人拉进群里之后跟他 /ping 一下即可得到。
$System_Config['telegram_chatid']='-1001108831440';
...
#Telegram 机器人账号
$System_Config['telegram_bot']='gfwhole_bot';

#Telegram 机器人在群组中不回应
$System_Config['telegram_group_quiet']='true';
...
$System_Config['payment_system']='zfbjk';
...
#alipay,zfbjk.com
$System_Config['zfbjk_pid']='20992';
$System_Config['zfbjk_key']='8567fa84978bcb9ae3adaf51b7b4d0d7';
$System_Config['zfbjk_qrcodeurl']='http://omgib13x8.bkt.clouddn.com/Pay.jpg';
