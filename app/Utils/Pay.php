    ...
    private static function f2fpay_html($user)
    {
            ...
            return '
                        ...
                        <select id="type" class="form-control" name="amount">
                            ...
                            <option value="'.Config::get('amount')[5].'">'.Config::get('amount')[5].'元</option>
                            <option value="'.Config::get('amount')[6].'">'.Config::get('amount')[6].'元</option>
                            <option value="'.Config::get('amount')[7].'">'.Config::get('amount')[7].'元</option>
                        </select>
                        <p></p>
